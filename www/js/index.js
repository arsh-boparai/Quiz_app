...
function rawData() {
    ...
    if (q_no >= question.length) {
        ...
        q.innerHTML = "<a href='index.html'<button class='ui-btn' style='background-color:#76b852;color:white;'>Reset quiz</button></a>";
        return false;
    }
    ...
    q.innerHTML += "<br><br><button onclick='checkAns()' type='submit' class='ui-btn' style='background-color:#76b852;color:white;'>Next</button>";
